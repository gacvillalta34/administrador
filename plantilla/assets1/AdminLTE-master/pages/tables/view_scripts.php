	...
	<!-- jQuery 2.1.3 -->
    <script src="plantilla/assets1/AdminLTE-master/plugins/jQuery/jQuery-2.1.3.min.js"></script>
    <!-- jQuery UI 1.11.2 -->
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="plantilla/assets1/AdminLTE-master/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>    
    <!-- Morris.js charts -->
